...
class StartWidget(QWidget):
    ...
    def initUI(self):
        ...
        cl_info_label.setToolTip(
            "Cognitive Load (CL) reflects the mental effort required for a task. "
        ...
        self.label_session = QLabel(
            "Please enter a label to identify following session."
        )
        ...
        layout.addWidget(
            self.start_session_button, alignment=Qt.AlignmentFlag.AlignCenter
        )
